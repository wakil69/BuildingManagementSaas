...
import OverlayRemoveEducation from "../overlayRemoveEducation/overlayRemoveEducation";

export default function EducationVisu() {
  ...
  return (
    <Box sx={{ width: "100%" }} id="education">
      ...
      >
        <Typography variant="h6">Niveau d'études</Typography>
        <motion.div
            ...
            >
              <TableContainer>
                <Table>
                  ...
                  <TableBody>
                    {studyLevels.map((studyLevel, index) => (
                      <TableRow
                        key={index}
                        sx={{
                          "&:hover": {
                      ...
                      >
                        <Dialog
                          open={isOpenDeleteFormule === studyLevel.study_level_id}
                          aria-labelledby="dialog-create-videos"
                          maxWidth="xl"
                          fullWidth
                        >
                          <DialogContent>
                            <OverlayRemoveEducation
                              setIsOpen={setIsOpenDeleteFormule}
                              name={studyLevel.name}
                              id={studyLevel.study_level_id}
                            />
                          </DialogContent>
                        </Dialog>
                        ...
                        >
                          <IconButton
                            color="error"
                            onClick={() =>
                              setIsOpenDeleteFormule(studyLevel.study_level_id)
                            }
                          >
                            <DeleteIcon />
                          </IconButton>
