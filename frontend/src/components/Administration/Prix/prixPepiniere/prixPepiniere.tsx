...
const validationSchemaModificationPepinierePrix = yup
  .object({
    prix: yup
      .array()
      .of(
        yup.object().shape({
          ...
          prix_type: yup.string().min(0).required("Le type de prix est requis"),
        })
      )
...
export default function PrixPepiniere({
  prix,
  dateDebut,
  dateFin,
  prixType,
  ...
  const {
    ...
    resolver: yupResolver(validationSchemaModificationPepinierePrix),
    defaultValues: {
          ...
          <Table>
            <TableHead>
              <TableRow>
                ...
                <TableCell style={{ width: "25%" }}>Montant Année 1</TableCell>
                <TableCell style={{ width: "25%" }}>Montant Année 2</TableCell>
                <TableCell style={{ width: "25%" }}>Montant Année 3</TableCell>
              </TableRow>
            </TableHead>
            <TableBody>
