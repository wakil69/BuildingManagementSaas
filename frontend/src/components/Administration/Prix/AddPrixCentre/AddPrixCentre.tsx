...
const validationSchemaAddCentrePrix = yup
  .object({
    prix: yup
      .array()
      .of(
...
export default function AddPrixCentre({
  setIsOpen,
  batimentID,
  potentialDateDebut,
  surfaces,
  ...
  const {
    ...
    resolver: yupResolver(validationSchemaAddCentrePrix),
    defaultValues: {
      prix:
        surfaces.map((surface: number) => {
          return {
            surface,
            prix_centre_affaires: 0,
          };
        }) || [],
    ...
    <Card>
      <CardContent>
        <Typography variant="h6" id="modal-title" gutterBottom>
          Ajouter un nouveau groupe de prix - Formule centre d'affaires
        </Typography>
                  ...
                  <TableRow key={index}>
                    ...
                    <TableCell>
                      <TextField
                        ...
                        defaultValue={item.prix_centre_affaires}
                      />
                    </TableCell>
                  </TableRow>
                ))}
