...
const validationSchemaModificationCoworkingPrix = yup
  .object({
    prix: yup
      .array()
      .of(
...
export default function PrixCoworking({
  prix,
  dateDebut,
  dateFin,
  prixType,
  ...
  const {
    ...
    resolver: yupResolver(validationSchemaModificationCoworkingPrix),
    defaultValues: {
                ...
                <TableRow key={field.id}>
                  ...
                  <TableCell>
                    <TextField
                      ...
                      defaultValue={field.prix_coworking ?? ""}
                    />
                  </TableCell>
                </TableRow>
              ))}
