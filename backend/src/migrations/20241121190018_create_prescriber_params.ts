...
export async function up(knex: Knex): Promise<void> {
    return knex.schema.createTable("prescribers_params", function (table) {
        table.increments("prescriber_id").primary()
...
export async function down(knex: Knex): Promise<void> {
    return knex.schema.dropTableIfExists("prescribers_params");
}
