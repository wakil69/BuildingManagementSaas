...
export async function up(knex: Knex): Promise<void> {
  return knex.schema.createTable("nature_equipements_params", function (table) {
    table.increments("nature_equipement_id").primary();
...
export async function down(knex: Knex): Promise<void> {
  return knex.schema.dropTableIfExists("nature_equipements_params");
}
