...
export async function up(knex: Knex): Promise<void> {
    return knex.schema.createTable("statuts_post_pep_params", function (table) {
        table.increments("statut_id").primary()
...
export async function down(knex: Knex): Promise<void> {
    return knex.schema.dropTableIfExists("statuts_post_pep_params");
}
