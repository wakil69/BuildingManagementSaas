...
export async function up(knex: Knex): Promise<void> {
    return knex.schema.createTable("relations_pm_pp_params", function (table) {
        table.increments("rel_typ_id").primary()
...
export async function down(knex: Knex): Promise<void> {
    return knex.schema.dropTableIfExists("relations_pm_pp_params");
}
