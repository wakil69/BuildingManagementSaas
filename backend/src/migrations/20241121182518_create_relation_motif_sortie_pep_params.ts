...
export async function up(knex: Knex): Promise<void> {
    return knex.schema.createTable("motifs_sortie_pep_params", function (table) {
        table.increments("motif_id").primary()
...
export async function down(knex: Knex): Promise<void> {
    return knex.schema.dropTableIfExists("motifs_sortie_pep_params");
}
