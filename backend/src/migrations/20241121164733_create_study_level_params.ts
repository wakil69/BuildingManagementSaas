...
export async function up(knex: Knex): Promise<void> {
    return knex.schema.createTable("study_level_params", function (table) {
        table.increments("study_level_id").primary()
...
export async function down(knex: Knex): Promise<void> {
    return knex.schema.dropTableIfExists("study_level_params");
}
